...
async function insertQueuedTask(
  ...
  await env.DB.prepare(
    `INSERT INTO agent_task
      (id, agent_id, content, status, result_status, summary, commands, files_touched, violations, diff_summary, commit_json, trace_id, proof_run_id, proof_iteration_id, attempt, request_id, error_code, error_detail, accepted_at, started_at, heartbeat_at, finished_at)
...
async function loadTaskRow(
  ...
  return env.DB.prepare(
    `SELECT id, agent_id, content, status, result_status, summary, commands, files_touched, violations,
            diff_summary, commit_json, trace_id, proof_run_id, proof_iteration_id, attempt, request_id, error_code, error_detail,
