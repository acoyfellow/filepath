...
<main class="max-w-3xl mx-auto px-6 py-12">
  ...
  <p class="text-neutral-400 mb-12">Available agents you can spawn.</p>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">shelley</code>
          </div>
          <p class="text-neutral-400 mb-3">Full-stack engineering agent. filepath-native reference implementation.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">pi</code>
          </div>
          <p class="text-neutral-400 mb-3">Research and analysis specialist. Deep dives into docs, APIs, codebases.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">claude-code</code>
          </div>
          <p class="text-neutral-400 mb-3">Anthropic's agentic coding tool. Complex multi-file changes.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">codex</code>
          </div>
          <p class="text-neutral-400 mb-3">OpenAI's coding agent. Strong at Python, scripting, data.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">openai/o3</code>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">cursor</code>
          </div>
          <p class="text-neutral-400 mb-3">Cursor's agent mode via CLI. IDE-grade code intelligence.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">amp</code>
          </div>
          <p class="text-neutral-400 mb-3">Sourcegraph's agent. Large codebase navigation, cross-repo changes.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
      ...
      <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
          <div class="flex items-center justify-between mb-2">
            ...
            <code class="text-xs bg-neutral-800 text-neutral-300 px-2 py-1 rounded">opencode</code>
          </div>
          <p class="text-neutral-400 mb-3">Open-source coding agent. Terminal-based development.</p>
          <div class="flex gap-2 text-sm">
            <span class="text-neutral-500">Default model:</span>
            <code class="text-neutral-400">anthropic/claude-sonnet-4</code>
          </div>
  ...
  <footer class="border-t border-neutral-800 pt-6 mt-12 text-center">
    <p class="text-neutral-500 text-sm">
      Want to add your agent? <a href="https://github.com/acoyfellow/filepath/discussions" class="text-neutral-300 hover:underline">Start a discussion</a>
    </p>
  </footer>
</main>
