...
<main class="max-w-3xl mx-auto px-6 py-12">
  ...
  <p class="text-neutral-400 mb-8">Override your account-level API key for specific sessions.</p>

  <div class="prose prose-invert prose-neutral max-w-none">
    <h2 class="text-xl font-medium text-neutral-200 mt-8 mb-4">When to Use This</h2>
    ...
    <p class="text-neutral-400 mb-6">If you set a per-session key, all agents in that session use it instead of your account key.</p>

    <h2 class="text-xl font-medium text-neutral-200 mt-8 mb-4">Setting a Session Key</h2>

    <h3 class="text-lg font-medium text-neutral-300 mt-6 mb-3">During Session Creation</h3>
    <ol class="list-decimal list-inside text-neutral-400 space-y-2 mb-6">
    ...
    <h3 class="text-lg font-medium text-neutral-300 mt-6 mb-3">After Session Creation</h3>
    <ol class="list-decimal list-inside text-neutral-400 space-y-2 mb-6">
    ...
    <div class="bg-neutral-900/50 border border-neutral-800 rounded p-4 mb-6">
      <p class="text-neutral-400">The change applies immediately to:</p>
    ...
    <p class="text-neutral-400">Agents will revert to using your account-level key.</p>
    ...
    <h2 class="text-xl font-medium text-neutral-200 mt-8 mb-4">Use Cases</h2>

    <div class="space-y-4 mb-6">
      <div class="bg-neutral-900/50 border border-neutral-800 rounded p-4">
        <h3 class="font-medium text-neutral-200 mb-2">Different Models</h3>
        <p class="text-neutral-400">Session A: OpenAI GPT-4 for analysis tasks<br>Session B: Claude for creative writing</p>
      </div>

      <div class="bg-neutral-900/50 border border-neutral-800 rounded p-4">
        <h3 class="font-medium text-neutral-200 mb-2">Team Projects</h3>
        <p class="text-neutral-400">- Personal account key: your individual work<br>- Session key: shared team key for group project</p>
      </div>

      <div class="bg-neutral-900/50 border border-neutral-800 rounded p-4">
        <h3 class="font-medium text-neutral-200 mb-2">Client Work</h3>
        <p class="text-neutral-400">- Account key: internal projects<br>- Session A key: Client A's OpenAI key<br>- Session B key: Client B's Anthropic key</p>
      </div>
    </div>

    <h2 class="text-xl font-medium text-neutral-200 mt-8 mb-4">Monitoring Usage</h2>
    <p class="text-neutral-400 mb-4">filepath tracks usage per-session:</p>
    <ol class="list-decimal list-inside text-neutral-400 space-y-2 mb-6">
    ...
    <h2 class="text-xl font-medium text-neutral-200 mt-8 mb-4">Troubleshooting</h2>
