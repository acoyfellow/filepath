...
<div class="min-h-screen font-sans {dark ? 'bg-neutral-950 text-neutral-300' : 'bg-gray-50 text-gray-700'} transition-colors duration-200">
  ...
  <main class="max-w-3xl mx-auto px-6 py-12">
    ...
    <h1 class="text-3xl font-medium {dark ? 'text-neutral-100' : 'text-gray-900'} mb-4">How to Use Per-Session API Keys</h1>
    <p class="{dark ? 'text-neutral-400' : 'text-gray-600'} mb-8">Override your account-level API key for specific sessions.</p>

    <div class="prose prose-invert prose-neutral max-w-none">
      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">When to Use This</h2>
      ...
      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">How It Works</h2>
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'} mb-4">filepath supports a 3-tier key resolution:</p>
      <ol class="list-decimal list-inside {dark ? 'text-neutral-400' : 'text-gray-600'} space-y-2 mb-6">
      ...
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'} mb-6">If you set a per-session key, all agents in that session use it instead of your account key.</p>

      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">Setting a Session Key</h2>

      <h3 class="text-lg font-medium {dark ? 'text-neutral-300' : 'text-gray-700'} mt-6 mb-3">During Session Creation</h3>
      <ol class="list-decimal list-inside {dark ? 'text-neutral-400' : 'text-gray-600'} space-y-2 mb-6">
      ...
      <h3 class="text-lg font-medium {dark ? 'text-neutral-300' : 'text-gray-700'} mt-6 mb-3">After Session Creation</h3>
      <ol class="list-decimal list-inside {dark ? 'text-neutral-400' : 'text-gray-600'} space-y-2 mb-6">
      ...
      <div class="bg-neutral-900/50 border {dark ? 'border-neutral-800' : 'border-gray-200'} rounded p-4 mb-6">
        <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">The change applies immediately to:</p>
      ...
      <h3 class="text-lg font-medium {dark ? 'text-neutral-300' : 'text-gray-700'} mt-6 mb-3">Removing a Session Key</h3>
      <ol class="list-decimal list-inside {dark ? 'text-neutral-400' : 'text-gray-600'} space-y-2 mb-6">
        <li>Go to <strong>Session Settings / Provider API Key</strong></li>
        <li>Click <strong>Remove Session Key</strong></li>
        <li>Confirm</li>
      </ol>
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">Agents will revert to using your account-level key.</p>

      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">Encryption & Security</h2>
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'} mb-4">Session keys are:</p>
      <ul class="space-y-2 {dark ? 'text-neutral-400' : 'text-gray-600'} mb-6">
      ...
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">Even filepath admins cannot see your keys.</p>

      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">Use Cases</h2>

      <div class="space-y-4 mb-6">
        <div class="bg-neutral-900/50 border {dark ? 'border-neutral-800' : 'border-gray-200'} rounded p-4">
          <h3 class="font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mb-2">Different Models</h3>
          <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">Session A: OpenAI GPT-4 for analysis tasks<br>Session B: Claude for creative writing</p>
        </div>

        <div class="bg-neutral-900/50 border {dark ? 'border-neutral-800' : 'border-gray-200'} rounded p-4">
          <h3 class="font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mb-2">Team Projects</h3>
          <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">- Personal account key: your individual work<br>- Session key: shared team key for group project</p>
        </div>

        <div class="bg-neutral-900/50 border {dark ? 'border-neutral-800' : 'border-gray-200'} rounded p-4">
          <h3 class="font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mb-2">Client Work</h3>
          <p class="{dark ? 'text-neutral-400' : 'text-gray-600'}">- Account key: internal projects<br>- Session A key: Client A's OpenAI key<br>- Session B key: Client B's Anthropic key</p>
        </div>
      </div>

      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">Monitoring Usage</h2>
      <p class="{dark ? 'text-neutral-400' : 'text-gray-600'} mb-4">filepath tracks usage per-session:</p>
      <ol class="list-decimal list-inside {dark ? 'text-neutral-400' : 'text-gray-600'} space-y-2 mb-6">
      ...
      <h2 class="text-xl font-medium {dark ? 'text-neutral-200' : 'text-gray-800'} mt-8 mb-4">Troubleshooting</h2>
