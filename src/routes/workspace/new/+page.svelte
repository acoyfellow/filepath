...
<SEO
  ...
  description="Create a new sandboxed workspace for bounded background agents in filepath."
...
<div class="flex min-h-screen items-center justify-center bg-(--bg2) px-4 py-10 font-(family-name:--f) text-(--t2)">
  <div class="w-full max-w-md">
    ...
    <Button variant="accent" class="h-11 w-full" disabled={isCreating} onclick={create}>
