...
- explicit thread state and event history
...
4. Threads can spawn child threads, hand files across the tree, and be reorganized while the work stays live.
...
- **Event stream**: the durable chat and runtime history for a thread
